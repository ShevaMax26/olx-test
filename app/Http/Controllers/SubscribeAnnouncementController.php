...
class SubscribeAnnouncementController extends AbstractController
{
    public function subscribe(Request $request, Connection $connection)
    {
        ...
        //2. Перевірка юзера. Якщо немає, то зберігаємо
        ...
        //3. Перевірка оголошення. Якщо немає, то зберігаємо
        $announcement = (new AnnouncementRepository($connection))->findByUrl($request->input('url'), $connection);
        ...
        //4. Перевірка чи є звʼязка юзер - оголошення в БД. Якщо немає, то створюємо
